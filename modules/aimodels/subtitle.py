...
class Document:
    ...
    def save_str_to_database(self, file_id, file_name, file_path, preview_path,
                             price, video_id, user_id, image_path):
        """
        生成预览图，并插入数据库
        :param file_id:
        :param file_name:
        ...
        flag = generate_pdf_picture(file_path, preview_path)
        if flag:
            document_dict = {
                '_id': file_id,
                'file_name': file_name,
