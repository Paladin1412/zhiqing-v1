...
# # #
# # #
# # # def str_split(_str, bg_str, ed_str, lang):
# # #     """
# # #     分割长字幕
# # #     :param _str:
# # #     :param bg_str:
...
# # #     :return:
# # #     """
# # #     bg_time = float(bg_str)
# # #     ed_time = float(ed_str)
# # #
# # #     split_chars = ',.?!，。！？；;'
# # #     raw_list = []
# # #
...
# # #     for _char in _str:
# # #         curr_str += _char
# # #         if _char in split_chars:
# # #             raw_list.append(curr_str)
# # #             curr_str = ''
# # #
# # #     if curr_str != '': raw_list.append(curr_str)
# # #
# # #     # print(raw_list)
# # #
# # #     res_list = []
# # #     lang_to_lenLimit = {'en': 100, 'cn': 40}
# # #     curr_str = ''
# # #     for sub_str in raw_list:
# # #         if len(curr_str + sub_str) > lang_to_lenLimit[lang]:
# # #             if curr_str == '':
# # #                 res_list.append(sub_str)
# # #             else:
# # #                 res_list.append(curr_str)
# # #
# # #             curr_str = sub_str
# # #         else:
# # #             curr_str += sub_str
# # #
# # #     if curr_str != '': res_list.append(curr_str)
# # #
# # #     # print(res_list)
# # #
# # #     final_list = []
# # #
# # #     total_len = len(_str)
# # #     total_dur = ed_time - bg_time
# # #
# # #     curr_progress = 0
# # #     for item in res_list:
# # #         delta_progress = round(len(item) / total_len, 3)
# # #
# # #         curr_bg = round(bg_time + total_dur * curr_progress, 2)
# # #         curr_ed = round(bg_time + total_dur * (curr_progress + delta_progress),
# # #                         2)
# # #
# # #         final_list.append([item, curr_bg, curr_ed])
# # #         curr_progress += delta_progress
# # #
# # #     return final_list
# # #
# # #
...
# # #
# # #         split_list = str_split(curr_sub, curr_bg, curr_ed, lang)
# # #         # print(res_list)
# # #         # curr_trans = ''
# # #         for curr_list in split_list:
# # #             i = 0
# # #             # print(curr_list)
...
# # #             )
# # #             i += 1
# # #             char_id_to_time[len(full_cn_str)] = bg
# # #             char_id_to_time[len(full_cn_str) + len(curr_cn_sub) - 1] = ed
# # #             time_to_char_id[bg] = len(full_cn_str)
# # #             time_to_char_id[ed] = len(full_cn_str) + len(curr_cn_sub) - 1
# # #
...
# # #
# # #     def save_str_to_database(self, file_id, file_name, file_path, image_path, price, video_id, user_id):
# # #         """
# # #         生成预览图，并插入数据库
# # #         :param file_id:
# # #         :param file_name:
...
# # # def main():
# # #     # 生成字幕
# # #     video_id = '1bd48e05ae823e9306c43d0357cc8eef'
...
# #     :return:
# #     """
# #     compress = "ffmpeg -i {} -y {}".format(srt_path, ass_path)
# #     is_run = os.system(compress)
# #     if is_run != 0:
# #         return ""
# #     else:
...
# #         self.document_collection = database.document
# #
# #     def save_str_to_database(self, file_id, file_name, file_path, image_path,
# #                              price, video_id):
# #         """
# #         生成预览图，并插入数据库
# #         :param file_id:
...
# #         :return:
# #         """
# #         full_str, char_id_to_page_id = dict_to_str_and_map(
# #             pdf_to_dict(file_path))
# #         flag = generate_pdf_picture(file_path, image_path)
# #         if flag:
# #             document_dict = {
# #                 '_id': file_id,
...
# #         self.audio_path = 'static/audios/' + video_id + '.mp3'
# #         self.srt_path = 'static/videos/' + video_id + '.srt'
# #         self.vtt_path = 'static/videos/' + video_id + '.vtt'
# #         self.ass_path = 'static/videos/' + video_id + '.ass'
# #
# #     def get_video_path(self, video_id):
# #         """
...
# #         dict_data = conversion(char_id_to_time)
# #         _data = {'subtitling': res_list, 'char_id_to_time': dict_data,
# #                  'full_cn_str': full_cn_str, 'vtt_path': vtt_path,
# #                  'lang': lang, 'audio_path': self.audio_path}
# #         self.video_collection.update_one(
# #             {"_id": video_id},
# #             {"$set": _data},
...
#                      'full_cn_str': full_cn_str, 'vtt_path': vtt_path,
#                      'lang': lang,
#                      'ass_path': ass_path, 'audio_path': self.audio_path}
#         self.video_collection.update_one(
#             {"_id": video_id},
#             {"$set": _data},
#             upsert=True)
